...
課程環境設定指南。按順序完成，最後跑就緒確認再進入 labs。

| 文件 | 用途 |
| --- | --- |
| [01a-setup-macos-python-environment.md](01a-setup-macos-python-environment.md) | macOS Python / conda 環境 |
...
| [03a-install-grafana-local.md](03a-install-grafana-local.md) | **路徑 A** — 本機 Grafana 安裝與資料來源設定 |
| [03b-setup-grafana-cloud.md](03b-setup-grafana-cloud.md) | **路徑 B** — Grafana Cloud 帳號、remote_write 設定與 dashboard 匯入 |
